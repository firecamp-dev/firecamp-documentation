...
### Examples
1. [How to write test cases for rest api?](/scripts/tests) Learn more
```ts
...
```
2. [How to use variables in tests script?](/scripts/variables#use-of-variables-in-scripts) Learn more
```ts
