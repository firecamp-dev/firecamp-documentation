...
### Examples
1. Learn more about [How to use variables in pre-request script?](/scripts/variables#use-of-variables-in-scripts) (Globals, Environment and Collection Variables)
```ts
