...
You can `Get`, `Set`, `Unset` globals variables by using the following snippets.
...
You can `Get`, `Set`, `Unset` environment variables by using the following snippets.
| Action        | Snippet |   Description |
| :------------ | :--------- | ----------: |
...
You can `Get`, `Set`, `Unset` collection variables by using the following snippets.
| Action        | Snippet |   Description |
| :------------ | :--------- | ----------: |
